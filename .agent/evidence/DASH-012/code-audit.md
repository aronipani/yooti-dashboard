...
✓ S3 buckets have block_public_access on all 4 settings — N/A (DynamoDB module)
✓ Encryption enabled on all storage resources — SSE enabled on DynamoDB table
✓ TLS enforced on all endpoints — N/A (DynamoDB handles TLS)
